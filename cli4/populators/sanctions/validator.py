"""
CLI4 Sanctions Validator
Comprehensive validation for vendor_sanctions table
"""
...
class SanctionsValidator:
    """Comprehensive validator for sanctions data"""
    ...
    def validate_all_sanctions(self, limit: Optional[int] = None) -> Dict[str, Any]:
        ...
        print("⚠️  COMPREHENSIVE SANCTIONS VALIDATION")
        print("=" * 60)
        print("Portal da Transparência CEIS data quality and corruption detection readiness")
        print()
    ...
    def _validate_core_data_integrity(self, records: List[Dict], validation: Dict):
        ...
        for record in records:
            ...
            if data_source != 'PORTAL_TRANSPARENCIA':
