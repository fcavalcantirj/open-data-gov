"""
CLI4 CNEP Validator
Comprehensive validation for CNEP sanctions data in vendor_sanctions table
"""
...
class CNEPValidator:
    """Comprehensive validator for CNEP sanctions data"""
    ...
    def validate_all_sanctions(self, limit: Optional[int] = None) -> Dict[str, Any]:
        ...
        print("⚠️  COMPREHENSIVE CNEP VALIDATION")
        print("=" * 60)
        print("Portal da Transparência CNEP data quality and corruption detection readiness")
        print()
        ...
        sanctions_records = database.execute_query(f"""
            ...
            WHERE data_source = 'PORTAL_TRANSPARENCIA_CNEP'
    ...
    def _validate_core_data_integrity(self, records: List[Dict], validation: Dict):
        ...
        for record in records:
            ...
            if data_source != 'PORTAL_TRANSPARENCIA_CNEP':
